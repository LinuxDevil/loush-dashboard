...
export const DIMENSIONS = Object.freeze([
  ...
  keyword('analyticalReasoning', 0.06, 'up', [
    ...
    'weigh', 'pros and cons', 'reason about', 'why does', 'why is',
  ]),
...
export const BOUNDARIES = Object.freeze({ simpleMax: -0.02, standardMax: 0.12, complexMax: 0.30 })
...
export const CONFIDENCE = Object.freeze({ k: 20, midpoint: 0.06, threshold: 0.45 })
