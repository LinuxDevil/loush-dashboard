...
export function TimeLens({ value, from, to, onChange, sprints, resolved }) {
  return <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '2px 2px 2px 8px', borderRadius: 6, background: 'var(--bg-surface-hover)', border: '1px solid var(--border-default)' }}>
      <span style={{ font: `500 9px ${MONO}`, letterSpacing: '0.06em', color: 'var(--text-secondary)', textTransform: 'uppercase' }}>window</span>
