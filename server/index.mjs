...
mountHarness(app, { chatBroadcast: (...a) => chatBroadcast(...a), chats, collectUsage: (...a) => collectUsage(...a) })
mountAgentTeams(app)

// ---------- project harness hub ----------
mountHarnessHub(app, { deepMerge: (...a) => deepMerge(...a), harnessResolve: (...a) => harnessResolve(...a), settingsFileFor: (...a) => settingsFileFor(...a) })
...
mountChatAnalytics(app, { chats, collectUsage: (...a) => collectUsage(...a), scanTranscripts: (...a) => scanTranscripts(...a) })
